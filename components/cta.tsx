        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-sm font-mono text-emerald-700 mb-4 uppercase tracking-widest">05 / Contact</h2>
              <p className="text-4xl md:text-5xl font-bold tracking-tighter mb-6">Let's build something.</p>
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 border border-emerald-900/30 flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">Detroit, MI</p>
            ...
            <motion.div
              ...
              className="mt-8 p-4 border border-border bg-zinc-900/50"
            >
          ...
          >
            <h3 className="text-lg font-bold uppercase tracking-wide mb-6">Send us a message</h3>
            ...
            {isSuccess ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-white text-black font-bold uppercase py-4 hover:bg-gray-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
